###########################################################################
## Makefile generated for component 'q_2dsfl_orr_lqg'. 
## 
## Makefile     : q_2dsfl_orr_lqg.mk
## Generated on : Mon Jun 08 20:15:42 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_2dsfl_orr_lqg.rt-win64
...
COMPILER_COMMAND_FILE     = q_2dsfl_orr_lqg_comp.rsp
CMD_FILE                  = q_2dsfl_orr_lqg.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_2dsfl_orr_lqg.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_2dsfl_orr_lqg -DNUMST=4 -DNCSTATES=12 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg.c $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_data.c $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_main.c $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetInf.c $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetNaN.c $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_2dsfl_orr_lqg.obj q_2dsfl_orr_lqg_data.obj q_2dsfl_orr_lqg_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_2dsfl_orr_lqg_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_2dsfl_orr_lqg_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_2dsfl_orr_lqg.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg.c


q_2dsfl_orr_lqg_data.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_data.c


q_2dsfl_orr_lqg_main.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\q_2dsfl_orr_lqg_main.c


rtGetInf.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_orr_lqg_quarc_win64\rt_nonfinite.c
