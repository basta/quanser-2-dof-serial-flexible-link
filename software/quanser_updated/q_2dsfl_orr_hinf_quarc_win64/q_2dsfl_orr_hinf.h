...
#ifndef RTW_HEADER_q_2dsfl_orr_hinf_h_
#define RTW_HEADER_q_2dsfl_orr_hinf_h_
#include <string.h>
#include <float.h>
#include <math.h>
#ifndef q_2dsfl_orr_hinf_COMMON_INCLUDES_
#define q_2dsfl_orr_hinf_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_2dsfl_orr_hinf_COMMON_INCLUDES_ */

#include "q_2dsfl_orr_hinf_types.h"
...
#define q_2dsfl_orr_hinf_rtModel       RT_MODEL_q_2dsfl_orr_hinf_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<S12>/Sum' */
  real_T div;                          /* '<S12>/div' */
} B_BiasRemoval_q_2dsfl_orr_hin_T;
...
} DW_BiasRemoval_q_2dsfl_orr_hi_T;
...
typedef struct {
  ...
  real_T AmpstoVolts;                  /* '<S2>/Amps to Volts' */
  ...
  B_BiasRemoval_q_2dsfl_orr_hin_T BiasRemoval_m;/* '<S2>/Bias Removal' */
  B_BiasRemoval_q_2dsfl_orr_hin_T BiasRemoval;/* '<S1>/Bias Removal' */
} B_q_2dsfl_orr_hinf_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T ORRHINF_DSTATE[7];            /* '<Root>/ORR HINF' */
  ...
  DW_BiasRemoval_q_2dsfl_orr_hi_T BiasRemoval_m;/* '<S2>/Bias Removal' */
  DW_BiasRemoval_q_2dsfl_orr_hi_T BiasRemoval;/* '<S1>/Bias Removal' */
} DW_q_2dsfl_orr_hinf_T;
...
#define rtB                            q_2dsfl_orr_hinf_B
#define BlockIO                        B_q_2dsfl_orr_hinf_T
#define rtX                            q_2dsfl_orr_hinf_X
#define ContinuousStates               X_q_2dsfl_orr_hinf_T
#define rtXdot                         q_2dsfl_orr_hinf_XDot
#define StateDerivatives               XDot_q_2dsfl_orr_hinf_T
#define tXdis                          q_2dsfl_orr_hinf_XDis
#define StateDisabled                  XDis_q_2dsfl_orr_hinf_T
#define rtP                            q_2dsfl_orr_hinf_P
#define Parameters                     P_q_2dsfl_orr_hinf_T
#define rtDWork                        q_2dsfl_orr_hinf_DW
#define D_Work                         DW_q_2dsfl_orr_hinf_T

/* Parameters for system: '<S1>/Bias Removal' */
struct P_BiasRemoval_q_2dsfl_orr_hin_T_ {
...
struct P_q_2dsfl_orr_hinf_T_ {
  ...
  real_T Gain_Gain_o;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T ORRHINF_A[43];                /* Computed Parameter: ORRHINF_A
                                        * Referenced by: '<Root>/ORR HINF'
                                        */
  real_T ORRHINF_B[3];                 /* Computed Parameter: ORRHINF_B
                                        * Referenced by: '<Root>/ORR HINF'
                                        */
  real_T ORRHINF_C[7];                 /* Computed Parameter: ORRHINF_C
                                        * Referenced by: '<Root>/ORR HINF'
                                        */
  real_T ORRHINF_InitialCondition;     /* Expression: 0
                                        * Referenced by: '<Root>/ORR HINF'
                                        */
  ...
  uint8_T ManualSwitch2_CurrentSetting;
                              ...
                              */
  P_BiasRemoval_q_2dsfl_orr_hin_T BiasRemoval_m;/* '<S2>/Bias Removal' */
  P_BiasRemoval_q_2dsfl_orr_hin_T BiasRemoval;/* '<S1>/Bias Removal' */
};

/* Real-time Model Data Structure */
struct tag_RTM_q_2dsfl_orr_hinf_T {
  const char_T *path;
...
extern P_q_2dsfl_orr_hinf_T q_2dsfl_orr_hinf_P;

/* Block signals (default storage) */
extern B_q_2dsfl_orr_hinf_T q_2dsfl_orr_hinf_B;

/* Continuous states (default storage) */
extern X_q_2dsfl_orr_hinf_T q_2dsfl_orr_hinf_X;

/* Block states (default storage) */
extern DW_q_2dsfl_orr_hinf_T q_2dsfl_orr_hinf_DW;

/* Model entry point functions */
extern void q_2dsfl_orr_hinf_initialize(void);
extern void q_2dsfl_orr_hinf_output(void);
extern void q_2dsfl_orr_hinf_update(void);
extern void q_2dsfl_orr_hinf_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_2dsfl_orr_hinf_rtModel *q_2dsfl_orr_hinf(void);
...
extern RT_MODEL_q_2dsfl_orr_hinf_T *const q_2dsfl_orr_hinf_M;
 ...
 *
 * '<Root>' : 'q_2dsfl_orr_hinf'
 * '<S1>'   : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant'
 * '<S2>'   : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant'
 * '<S3>'   : 'q_2dsfl_orr_hinf/Enable AMPAQ'
 * '<S4>'   : 'q_2dsfl_orr_hinf/Limit Switches'
 * '<S5>'   : 'q_2dsfl_orr_hinf/Scopes - Stage 1'
 * '<S6>'   : 'q_2dsfl_orr_hinf/Scopes - Stage 2'
 * '<S7>'   : 'q_2dsfl_orr_hinf/Stage 1 Setpoint'
 * '<S8>'   : 'q_2dsfl_orr_hinf/Stage 2 Setpoint'
 * '<S9>'   : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal'
 * '<S10>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog'
 * '<S11>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Radians to Degrees'
 * '<S12>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Enabled Moving Average'
 * '<S13>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem'
 * '<S14>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem1'
 * '<S15>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem2'
 * '<S16>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Enabled Moving Average/Increment'
 * '<S17>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message'
 * '<S18>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message1'
 * '<S19>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message/Compare'
 * '<S20>'  : 'q_2dsfl_orr_hinf/1st Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message1/Compare'
 * '<S21>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal'
 * '<S22>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog'
 * '<S23>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Radians to Degrees'
 * '<S24>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Enabled Moving Average'
 * '<S25>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem'
 * '<S26>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem1'
 * '<S27>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Switch Case Action Subsystem2'
 * '<S28>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Bias Removal/Enabled Moving Average/Increment'
 * '<S29>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message'
 * '<S30>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message1'
 * '<S31>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message/Compare'
 * '<S32>'  : 'q_2dsfl_orr_hinf/2nd Stage: 2-DOF SFL Robot: Actual Plant/Position Watchdog/Stop with Message1/Compare'
 * '<S33>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message'
 * '<S34>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message1'
 * '<S35>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message2'
 * '<S36>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message3'
 * '<S37>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message/Compare'
 * '<S38>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message1/Compare'
 * '<S39>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message2/Compare'
 * '<S40>'  : 'q_2dsfl_orr_hinf/Limit Switches/Stop with Message3/Compare'
 * '<S41>'  : 'q_2dsfl_orr_hinf/Scopes - Stage 1/rad2deg 1'
 * '<S42>'  : 'q_2dsfl_orr_hinf/Scopes - Stage 1/rad2deg 2'
 * '<S43>'  : 'q_2dsfl_orr_hinf/Scopes - Stage 2/rad2deg 1'
 * '<S44>'  : 'q_2dsfl_orr_hinf/Scopes - Stage 2/rad2deg 2'
 * '<S45>'  : 'q_2dsfl_orr_hinf/Stage 1 Setpoint/Degrees to Radians'
 * '<S46>'  : 'q_2dsfl_orr_hinf/Stage 1 Setpoint/Repeating Sequence Stair'
 * '<S47>'  : 'q_2dsfl_orr_hinf/Stage 1 Setpoint/Repeating Sequence Stair/LimitedCounter'
 * '<S48>'  : 'q_2dsfl_orr_hinf/Stage 1 Setpoint/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S49>'  : 'q_2dsfl_orr_hinf/Stage 1 Setpoint/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 * '<S50>'  : 'q_2dsfl_orr_hinf/Stage 2 Setpoint/Degrees to Radians1'
 */
#endif                                 /* RTW_HEADER_q_2dsfl_orr_hinf_h_ */
