###########################################################################
## Makefile generated for component 'q_2dsfl_open_loop'. 
## 
## Makefile     : q_2dsfl_open_loop.mk
## Generated on : Thu May 14 15:25:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_2dsfl_open_loop.rt-win64
...
PRODUCT_NAME              = q_2dsfl_open_loop
MAKEFILE                  = q_2dsfl_open_loop.mk
MATLAB_ROOT               = C:\MATLAB\R2021a
MATLAB_BIN                = C:\MATLAB\R2021a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\bastaond\ORR\quanser-2-dof-serial-flexible-link\software\quanser_updated
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = q_2dsfl_open_loop_comp.rsp
CMD_FILE                  = q_2dsfl_open_loop.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_2dsfl_open_loop.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_2dsfl_open_loop -DNUMST=2 -DNCSTATES=20 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop.c $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_data.c $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_main.c $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetInf.c $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetNaN.c $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_2dsfl_open_loop.obj q_2dsfl_open_loop_data.obj q_2dsfl_open_loop_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_2dsfl_open_loop_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_2dsfl_open_loop_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_2dsfl_open_loop.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop.c


q_2dsfl_open_loop_data.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_data.c


q_2dsfl_open_loop_main.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\q_2dsfl_open_loop_main.c


rtGetInf.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_2dsfl_open_loop_quarc_win64\rt_nonfinite.c
