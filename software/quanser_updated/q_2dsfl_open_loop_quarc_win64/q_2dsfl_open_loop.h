...
#ifndef RTW_HEADER_q_2dsfl_open_loop_h_
#define RTW_HEADER_q_2dsfl_open_loop_h_
#include <math.h>
#include <string.h>
#ifndef q_2dsfl_open_loop_COMMON_INCLUDES_
#define q_2dsfl_open_loop_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_2dsfl_open_loop_COMMON_INCLUDES_ */

#include "q_2dsfl_open_loop_types.h"
...
#define q_2dsfl_open_loop_rtModel      RT_MODEL_q_2dsfl_open_loop_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<S12>/Sum' */
  real_T div;                          /* '<S12>/div' */
} B_BiasRemoval_q_2dsfl_open_lo_T;
...
} DW_BiasRemoval_q_2dsfl_open_l_T;

/* Block signals (default storage) */
typedef struct {
  real_T Im_r1;                        /* '<Root>/Im_r1' */
  real_T Motor1EncoderCalib;           /* '<S1>/Motor #1 Encoder Calib' */
  real_T Gain[2];                      /* '<S41>/Gain' */
  real_T Gain_a[2];                    /* '<S42>/Gain' */
  real_T positiveCCW;                  /* '<S1>/positive  CCW' */
  real_T VoltstoBaseStrain;            /* '<S1>/Volts to Base Strain' */
  ...
  real_T Gain_p[2];                    /* '<S43>/Gain' */
  real_T Gain_m[2];                    /* '<S44>/Gain' */
  real_T positiveCCW_l;                /* '<S2>/positive  CCW' */
  real_T VoltstoStrain;                /* '<S2>/Volts to Strain' */
  real_T Im_r2Saturation;              /* '<Root>/Im_r2: Saturation' */
  real_T VoltstoAmps_h;                /* '<S2>/Volts to Amps' */
  real_T AmpstoVolts_d;                /* '<S2>/Amps to Volts' */
  real_T StraintoDeflection_g;         /* '<S2>/Strain to Deflection' */
  ...
  boolean_T Compare_p;                 /* '<S32>/Compare' */
  boolean_T CheckMaximumAllowedPosition_a;
                                    /* '<S10>/Check Maximum Allowed Position' */
  boolean_T Compare_l;                 /* '<S19>/Compare' */
  boolean_T CheckMinimumAllowedPosition_d;
                                    /* '<S10>/Check Minimum Allowed Position' */
  boolean_T Compare_b;                 /* '<S20>/Compare' */
  B_BiasRemoval_q_2dsfl_open_lo_T BiasRemoval_e;/* '<S2>/Bias Removal' */
  B_BiasRemoval_q_2dsfl_open_lo_T BiasRemoval;/* '<S1>/Bias Removal' */
} B_q_2dsfl_open_loop_T;
...
typedef struct {
  ...
  real_T HILReadAnalog_Buffer_d[2];    /* '<S2>/HIL Read Analog' */
  ...
  struct {
    void *LoggedData;
  } BaseStrainmmmm_PWORK;              /* '<S1>/Base Strain (mm//mm)' */
  ...
  void *HILReadAnalog_PWORK_k;         /* '<S2>/HIL Read Analog' */
  struct {
    void *LoggedData;
  } BaseStrainmmmm_PWORK_b;            /* '<S2>/Base Strain (mm//mm)' */

  struct {
    void *LoggedData;
  } CurrentResponse2A_PWORK;           /* '<S2>/Current Response #2 (A)' */

  void *HILWriteAnalog_PWORK_b;        /* '<S2>/HIL Write Analog' */
  struct {
    void *LoggedData;
  ...
  int8_T PositionWatchdog_SubsysRanBC_b;/* '<S1>/Position Watchdog' */
  ...
  boolean_T PositionWatchdog_MODE_k;   /* '<S1>/Position Watchdog' */
  DW_BiasRemoval_q_2dsfl_open_l_T BiasRemoval_e;/* '<S2>/Bias Removal' */
  DW_BiasRemoval_q_2dsfl_open_l_T BiasRemoval;/* '<S1>/Bias Removal' */
} DW_q_2dsfl_open_loop_T;

/* Continuous states (default storage) */
typedef struct {
  real_T ustStage2DOFSFJRobotStateSpaceM[4];
                    /* '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model' */
  ...
  real_T undStage2DOFSFJRobotStateSpaceM[4];
                    /* '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model' */
  real_T DerivativeFilter3_CSTATE[2];  /* '<S2>/Derivative Filter3' */
  real_T DerivativeFilter1_CSTATE_a[2];/* '<S2>/Derivative Filter1' */
  real_T DerivativeFilter2_CSTATE_l[2];/* '<S2>/Derivative Filter2' */
} X_q_2dsfl_open_loop_T;
...
typedef struct {
  ...
  real_T DerivativeFilter1_CSTATE_a[2];/* '<S2>/Derivative Filter1' */
  real_T DerivativeFilter2_CSTATE_l[2];/* '<S2>/Derivative Filter2' */
} XDot_q_2dsfl_open_loop_T;

/* State disabled  */
typedef struct {
  boolean_T ustStage2DOFSFJRobotStateSpaceM[4];
                    /* '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model' */
  ...
  boolean_T undStage2DOFSFJRobotStateSpaceM[4];
                    /* '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model' */
  boolean_T DerivativeFilter3_CSTATE[2];/* '<S2>/Derivative Filter3' */
  boolean_T DerivativeFilter1_CSTATE_a[2];/* '<S2>/Derivative Filter1' */
  boolean_T DerivativeFilter2_CSTATE_l[2];/* '<S2>/Derivative Filter2' */
} XDis_q_2dsfl_open_loop_T;
...
#define rtB                            q_2dsfl_open_loop_B
#define BlockIO                        B_q_2dsfl_open_loop_T
#define rtX                            q_2dsfl_open_loop_X
#define ContinuousStates               X_q_2dsfl_open_loop_T
#define rtXdot                         q_2dsfl_open_loop_XDot
#define StateDerivatives               XDot_q_2dsfl_open_loop_T
#define tXdis                          q_2dsfl_open_loop_XDis
#define StateDisabled                  XDis_q_2dsfl_open_loop_T
#define rtP                            q_2dsfl_open_loop_P
#define Parameters                     P_q_2dsfl_open_loop_T
#define rtDWork                        q_2dsfl_open_loop_DW
#define D_Work                         DW_q_2dsfl_open_loop_T

/* Parameters for system: '<S1>/Bias Removal' */
struct P_BiasRemoval_q_2dsfl_open_lo_T_ {
...
struct P_q_2dsfl_open_loop_T_ {
  real_T A1[16];                       /* Variable: A1
                                        * Referenced by: '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  real_T A2[16];                       /* Variable: A2
                                        * Referenced by: '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  real_T B1[4];                        /* Variable: B1
                                        * Referenced by: '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  real_T B2[4];                        /* Variable: B2
                                        * Referenced by: '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  real_T C1[16];                       /* Variable: C1
                                        * Referenced by: '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  real_T C2[16];                       /* Variable: C2
                                        * Referenced by: '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model'
                                        */
  ...
  real_T BiasRemoval_end_time;         /* Mask Parameter: BiasRemoval_end_time
                                        ...
                                        */
  real_T BiasRemoval_end_time_n;       /* Mask Parameter: BiasRemoval_end_time_n
                                        * Referenced by: '<S2>/Bias Removal'
                                        */
  real_T BiasRemoval_start_time;       /* Mask Parameter: BiasRemoval_start_time
                                        * Referenced by: '<S1>/Bias Removal'
                                        */
  real_T BiasRemoval_start_time_k;   /* Mask Parameter: BiasRemoval_start_time_k
                                      * Referenced by: '<S2>/Bias Removal'
                                      */
  real_T BiasRemoval_switch_id;        /* Mask Parameter: BiasRemoval_switch_id
                                        * Referenced by: '<S1>/Bias Removal'
                                        */
  real_T BiasRemoval_switch_id_c;     /* Mask Parameter: BiasRemoval_switch_id_c
                                       * Referenced by: '<S2>/Bias Removal'
                                       */
  ...
  uint32_T HILReadEncoder_channels;   /* Mask Parameter: HILReadEncoder_channels
                                       ...
                                       */
  uint32_T HILReadAnalog_channels_g[2];
                                     /* Mask Parameter: HILReadAnalog_channels_g
                                      * Referenced by: '<S2>/HIL Read Analog'
                                      */
  uint32_T HILWriteAnalog_channels_j;
                                    /* Mask Parameter: HILWriteAnalog_channels_j
  ...
  int8_T StopwithMessage_message_icon_a;
                                ...
                                */
  int8_T StopwithMessage1_message_icon_p;
                              /* Mask Parameter: StopwithMessage1_message_icon_p
                               * Referenced by: '<S30>/Show Message on Host'
                               */
  int8_T StopwithMessage_message_icon_aa;
                              /* Mask Parameter: StopwithMessage_message_icon_aa
                               * Referenced by: '<S33>/Show Message on Host'
                               */
  int8_T StopwithMessage1_message_icon_c;
                              /* Mask Parameter: StopwithMessage1_message_icon_c
  ...
  int8_T StopwithMessage3_message_icon;
                                 ...
                                 */
  real_T AmplitudeA_Gain;              /* Expression: 0.3
                                        * Referenced by: '<S8>/Amplitude (A)'
                                        */
  real_T Im_r2_Gain;                   /* Expression: 0.3
                                        * Referenced by: '<Root>/Im_r2'
                                        */
  real_T AmplitudeA_Gain_j;            /* Expression: 0.75
                                        * Referenced by: '<S7>/Amplitude (A)'
                                        */
  ...
  real_T SignalGenerator_Frequency;    /* Expression: 1
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T Im_r1_Gain;                   /* Expression: 0
                                        * Referenced by: '<Root>/Im_r1'
                                        */
  real_T ustStage2DOFSFJRobotStateSpaceM;/* Expression: 0
                                          * Referenced by: '<Root>/1st Stage: 2-DOF SFJ Robot: State-Space Model'
                                          */
  ...
  real_T Step_YFinal;                  /* Expression: 1
                                        * Referenced by: '<S8>/Step'
                                        */
  real_T Step1_Time;                   /* Expression: 1.2
  ...
  real_T DerivativeFilter2_C[2];      /* Computed Parameter: DerivativeFilter2_C
                                       * Referenced by: '<S1>/Derivative Filter2'
                                       */
  real_T undStage2DOFSFJRobotStateSpaceM;/* Expression: 0
                                          * Referenced by: '<Root>/2nd Stage: 2-DOF SFJ Robot: State-Space Model'
                                          */
  real_T Gain_Gain_m4;                 /* Expression: 180/pi
  ...
  real_T Gain_Gain_g;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T DerivativeFilter1_A_l[2];  /* Computed Parameter: DerivativeFilter1_A_l
                                     * Referenced by: '<S2>/Derivative Filter1'
                                     */
  real_T DerivativeFilter1_C_o[2];  /* Computed Parameter: DerivativeFilter1_C_o
                                     * Referenced by: '<S2>/Derivative Filter1'
                                     */
  real_T SignalGenerator1_Amplitude;   /* Expression: 1
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  real_T SignalGenerator1_Frequency;   /* Expression: 1
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  ...
  real_T Step_YFinal_n;                /* Expression: 1
                                        * Referenced by: '<S7>/Step'
                                        */
  real_T Step1_Time_h;                 /* Expression: 1.2
                                        * Referenced by: '<S7>/Step1'
                                        */
  real_T Step1_Y0_g;                   /* Expression: 0
                                        * Referenced by: '<S7>/Step1'
                                        */
  real_T Step1_YFinal_e;               /* Expression: -1
                                        * Referenced by: '<S7>/Step1'
                                        */
  ...
  real_T Im_r2Saturation_LowerSat;     /* Expression: -1.2
                                        * Referenced by: '<Root>/Im_r2: Saturation'
                                        */
  real_T VoltstoAmps_Gain_g;           /* Expression: -2.0
                                        * Referenced by: '<S2>/Volts to Amps'
                                        */
  real_T AmpstoVolts_Gain_e;           /* Expression: 1/0.5
                                        * Referenced by: '<S2>/Amps to Volts'
                                        */
  real_T Gain_Gain_n5;                 /* Expression: 180/pi
                                        * Referenced by: '<S23>/Gain'
                                        */
  real_T DerivativeFilter2_A_g[2];  /* Computed Parameter: DerivativeFilter2_A_g
                                     * Referenced by: '<S2>/Derivative Filter2'
                                     */
  real_T DerivativeFilter2_C_f[2];  /* Computed Parameter: DerivativeFilter2_C_f
                                     * Referenced by: '<S2>/Derivative Filter2'
                                     */
  ...
  boolean_T Constant_Value_f;          /* Computed Parameter: Constant_Value_f
                                        ...
                                        */
  boolean_T Constant_Value_kl;         /* Computed Parameter: Constant_Value_kl
  ...
  boolean_T HILReadEncoder_Active;  /* Computed Parameter: HILReadEncoder_Active
                                     * Referenced by: '<S2>/HIL Read Encoder'
                                     */
  boolean_T HILReadAnalog_Active_p;/* Computed Parameter: HILReadAnalog_Active_p
                                    * Referenced by: '<S2>/HIL Read Analog'
                                    */
  boolean_T HILWriteAnalog_Active_a;
                                  /* Computed Parameter: HILWriteAnalog_Active_a
                                   * Referenced by: '<S2>/HIL Write Analog'
                                   */
  ...
  uint8_T ManualSwitch_CurrentSetting;
                               ...
                               */
  P_BiasRemoval_q_2dsfl_open_lo_T BiasRemoval_e;/* '<S2>/Bias Removal' */
  P_BiasRemoval_q_2dsfl_open_lo_T BiasRemoval;/* '<S1>/Bias Removal' */
};

/* Real-time Model Data Structure */
struct tag_RTM_q_2dsfl_open_loop_T {
  const char_T *path;
...
extern P_q_2dsfl_open_loop_T q_2dsfl_open_loop_P;

/* Block signals (default storage) */
extern B_q_2dsfl_open_loop_T q_2dsfl_open_loop_B;

/* Continuous states (default storage) */
extern X_q_2dsfl_open_loop_T q_2dsfl_open_loop_X;

/* Block states (default storage) */
extern DW_q_2dsfl_open_loop_T q_2dsfl_open_loop_DW;

/* Model entry point functions */
extern void q_2dsfl_open_loop_initialize(void);
extern void q_2dsfl_open_loop_output(void);
extern void q_2dsfl_open_loop_update(void);
extern void q_2dsfl_open_loop_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_2dsfl_open_loop_rtModel *q_2dsfl_open_loop(void);
...
extern RT_MODEL_q_2dsfl_open_loop_T *const q_2dsfl_open_loop_M;
 ...
 *
 * '<Root>' : 'q_2dsfl_open_loop'
 * '<S1>'   : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant'
 * '<S2>'   : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant'
 * '<S3>'   : 'q_2dsfl_open_loop/Enable AMPAQ'
 * '<S4>'   : 'q_2dsfl_open_loop/Limit Switches'
 * '<S5>'   : 'q_2dsfl_open_loop/Scopes - Stage 1'
 * '<S6>'   : 'q_2dsfl_open_loop/Scopes - Stage 2'
 * '<S7>'   : 'q_2dsfl_open_loop/Short Step1'
 * '<S8>'   : 'q_2dsfl_open_loop/Short Step2'
 * '<S9>'   : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal'
 * '<S10>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog'
 * '<S11>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Radians to Degrees'
 * '<S12>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Enabled Moving Average'
 * '<S13>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem'
 * '<S14>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem1'
 * '<S15>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem2'
 * '<S16>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Enabled Moving Average/Increment'
 * '<S17>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message'
 * '<S18>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message1'
 * '<S19>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message/Compare'
 * '<S20>'  : 'q_2dsfl_open_loop/1st Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message1/Compare'
 * '<S21>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal'
 * '<S22>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog'
 * '<S23>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Radians to Degrees'
 * '<S24>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Enabled Moving Average'
 * '<S25>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem'
 * '<S26>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem1'
 * '<S27>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Switch Case Action Subsystem2'
 * '<S28>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Bias Removal/Enabled Moving Average/Increment'
 * '<S29>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message'
 * '<S30>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message1'
 * '<S31>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message/Compare'
 * '<S32>'  : 'q_2dsfl_open_loop/2nd Stage: 2-DOF SFL Robot + Q8: Actual Plant/Position Watchdog/Stop with Message1/Compare'
 * '<S33>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message'
 * '<S34>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message1'
 * '<S35>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message2'
 * '<S36>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message3'
 * '<S37>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message/Compare'
 * '<S38>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message1/Compare'
 * '<S39>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message2/Compare'
 * '<S40>'  : 'q_2dsfl_open_loop/Limit Switches/Stop with Message3/Compare'
 * '<S41>'  : 'q_2dsfl_open_loop/Scopes - Stage 1/rad2deg 1'
 * '<S42>'  : 'q_2dsfl_open_loop/Scopes - Stage 1/rad2deg 2'
 * '<S43>'  : 'q_2dsfl_open_loop/Scopes - Stage 2/rad2deg 1'
 * '<S44>'  : 'q_2dsfl_open_loop/Scopes - Stage 2/rad2deg 2'
 */
#endif                                 /* RTW_HEADER_q_2dsfl_open_loop_h_ */
